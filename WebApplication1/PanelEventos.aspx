...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <asp:Button ID="Button1" runat="server"  class="btn btn-primary" Text="Añadir" OnClick="ButAnyadirNuevoEvento" />
                    </div>
                </div>
            </div>
        </div>
       ...
       <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="Solid" 
           ...
           PageSize="4" DataKeyNames="idEvento" DataSourceID="SqlDataSource1" OnRowDeleting="EventoEliminado"> 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AtlantisConnectionString %>" 
            SelectCommand="EventosUsuario" SelectCommandType="StoredProcedure" DeleteCommand="BorrarEvento" DeleteCommandType="StoredProcedure" >
            <DeleteParameters>
